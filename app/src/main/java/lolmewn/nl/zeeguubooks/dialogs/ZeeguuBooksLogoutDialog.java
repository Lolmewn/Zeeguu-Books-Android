 ...
 */
public class ZeeguuBooksLogoutDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle(ch.unibe.R.string.logout_zeeguu_confirmation);
        builder.setCancelable(true);
        builder.setPositiveButton(ch.unibe.R.string.logout_zeeguu_title, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        callback.zeeguuLogout();
                    }
                }
        );
