...
import lolmewn.nl.zeeguubooks.javascript.JavascriptHandler;
...
public class BookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String bookURL = getIntent().getExtras().getString("book_url");
        String epubURL = getIntent().getExtras().getString("epub_url");
        final String token = getIntent().getExtras().getString("token");
        final String scopes = getString(R.string.books_scope);
        ...
        mWebView.setWebChromeClient(new WebChromeClient() {
            ...
            public void onProgressChanged(WebView view, int newProgress) {
                ...
                BookActivity.this.setProgress(newProgress * 1000);
            }
        });
        mWebView.setWebViewClient(new WebViewClient() {
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                Toast.makeText(BookActivity.this, "Oh no! " + description, Toast.LENGTH_SHORT).show();
            }
        });
