...
public class ZeeguuSettingsFragment extends PreferenceFragment implements
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        switch (key) {
            case "pref_zeeguu_email":
                updateAccount();
                break;
            case "pref_zeeguu_language_native":
                updateNativeLanguage();
                break;
            case "pref_zeeguu_language_learning":
                updateLearningLanguage();
                break;
        }
    }
